...
figure
hold on
plot(P_T_values,(Served_all(1,:)),"black", 'LineStyle','--','LineWidth',1.5,'Marker', 'none')
plot(P_T_values,(Served_all(2,:)),"black",'LineStyle',':','LineWidth',1.5,'Marker', 'none')
plot(P_T_values,(Served_all(3,:)),"black",'LineStyle','-.','LineWidth',1.5,'Marker', 'none')
%plot(users,smoothdata(A_time_array),"black",'LineStyle','-','LineWidth',1.5,'Marker', 'none')
hold off
...
figure
hold on
plot(P_T_values,(Pused_all(1,:)),"black", 'LineStyle','--','LineWidth',1.5,'Marker', 'none')
plot(P_T_values,(Pused_all(2,:)),"black",'LineStyle',':','LineWidth',1.5,'Marker', 'none')
plot(P_T_values,(Pused_all(3,:)),"black",'LineStyle','-.','LineWidth',1.5,'Marker', 'none')
%plot(users,smoothdata(A_time_array),"black",'LineStyle','-','LineWidth',1.5,'Marker', 'none')
hold off
%title('DB vs GA vs MILP vs MILP_{split} Exectution Time')
xlabel('Power [W]','FontSize',12,'FontName','Computer Modern')
...
figure
hold on
plot(P_T_values,(Bused_all(1,:)),"black", 'LineStyle','--','LineWidth',1.5,'Marker', 'none')
plot(P_T_values,(Bused_all(2,:)),"black",'LineStyle',':','LineWidth',1.5,'Marker', 'none')
plot(P_T_values,(Bused_all(3,:)),"black",'LineStyle','-.','LineWidth',1.5,'Marker', 'none')
%plot(users,smoothdata(A_time_array),"black",'LineStyle','-','LineWidth',1.5,'Marker', 'none')
hold off
%title('DB vs GA vs MILP vs MILP_{split} Exectution Time')
xlabel('Power [W]','FontSize',12,'FontName','Computer Modern')
